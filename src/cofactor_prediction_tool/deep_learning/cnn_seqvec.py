...
def load_data():
    dataset_name = "/home/jgoncalves/cofactor_prediction_tool/data/Final/SeqVec/seqvec.h5"
...
def train_model(model, criterion, optimizer, scheduler, dataloaders, dataset_sizes, num_epochs=25, trial=None):
    ...
    with TemporaryDirectory() as tempdir:
        ...
        plt.legend()
        plt.savefig("/home/jgoncalves/cofactor_prediction_tool/data/Final/SeqVec/cnn/losses.png")
        print(f'Training complete in {time_elapsed // 60:.0f}m {time_elapsed % 60:.0f}s')
        print(f'Best val R2: {best_f1:4f}')
        with open("/home/jgoncalves/cofactor_prediction_tool/data/Final/SeqVec/cnn/best_f1.txt", "w") as f:
            f.write(str(best_f1))
...
def test_model(model, x_test_tensor, y_test_tensor, outlabels, metabolite=None, filename="predictions_test.tsv"):
    ...
    with torch.no_grad():
        ...
        with open('/home/jgoncalves/cofactor_prediction_tool/data/Final/SeqVec/cnn/results.txt', 'w') as f:
...
def run(params=None, trial=None):
    ...
    torch.save(model, "/home/jgoncalves/cofactor_prediction_tool/data/Final/SeqVec/cnn/best_CNN.pth")
    f1_score = test_model(model, X_test_tensor, y_test_tensor, labels, filename = '/home/jgoncalves/cofactor_prediction_tool/data/Final/SeqVec/cnn/predictions_test.tsv')
...
def hpo_optuna():
    ...
    f1_score = test_model(loaded_model, X_test_tensor, y_test_tensor, labels, filename = '/home/jgoncalves/cofactor_prediction_tool/data/Final/SeqVec/cnn/predictions_test.tsv')
