...
process predict{ 
    ...
    import shutil
    import pandas as pd
    from cofactor_prediction_tool.deep_learning.cnn_esm import CNNModel
    from cofactor_prediction_tool.deep_learning.cnn_esm import predict, predict_proba, load_model
...
workflow  { 
    ...
    (predictions, predictions_proba) = predict(embeddings_channel, 'esm2')
